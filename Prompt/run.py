...
def main(rank, config, world_size):
    ...
    if config.do_train:
        ...
        for path in os.listdir(config.save_dir):
            if path.endswith('.pth'):
                checkpoint_path = os.path.join(config.save_dir, path)
    ...
    #     test_dataloader = prepare(config, logger, mode='test', rank=rank, world_size=world_size, pin_memory=False, num_workers=0)
    #     checkpoint_paths = ["./saved/bert-base-chinese/Truncated/fold-0/f1_83.491.pth",
    #                         "./saved/bert-base-chinese/Truncated/fold-1/f1_83.365.pth",
    #                         "./saved/bert-base-chinese/Truncated/fold-2/f1_83.339.pth",
    #                         "./saved/bert-base-chinese/Truncated/fold-3/f1_83.314.pth",
    #                         # "./saved/bert-base-chinese/Truncated/fold-4/f1_83.612.pth",
    #                         ]
    #     model_list = []
...
if __name__ == '__main__':
    ...
    if not os.path.exists(config.result_dir) and config.do_infer:
